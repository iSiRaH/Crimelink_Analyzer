...
export default function ReturnWeaponModal({ weapon, onClose }: Props) {
  ...
  const [selectedReceivedById, setSelectedReceivedById] = useState<
    number | null
  >(null);
  ...
  const selectedReceivedBy = officers.find(
    (o) => o.id === selectedReceivedById,
  );
  ...
  const handleReturn = async () => {
    ...
    try {
      const payload = {
        ...
        returnedMagazines: returnedMagazines
          ? Number(returnedMagazines)
          : undefined,
      ...
      alert(
        err?.response?.data?.error || err?.message || "Failed to return weapon",
      );
    } finally {
      setLoading(false);
    }
        ...
        >
          ...
          {overdueDays > 0 && (
            ...
            >
              ...
              <div>
                ...
                >
                  This weapon is overdue by <strong>{overdueDays}</strong>{" "}
                  day(s)
                </p>
              </div>
            </div>
              ...
              <Section label="Personnel Information">
                <div style={{ marginBottom: "12px" }}>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSelectedReceivedById(Number(e.target.value))
                    }
                ...
                >
                  ...
                  <PersonnelCard
                    ...
                    role={
                      selectedReceivedBy?.rank ??
                      selectedReceivedBy?.role ??
                      "—"
                    }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        marginTop: "6px",
                        borderColor:
                          missingMagazines > 0 ? "#dc2626" : "#0e3a6e",
                      }}
                    />
                  </div>
                  <div>
          ...
          >
            ...
            >
              ...
              >
                I confirm all information is accurate. I verify the weapon
                condition, ammunition count, and return details are correct to
...
function PersonnelCard({
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <p style={{ color: "#1a3a5c", fontSize: "14px", margin: 0 }}>
          Loading...
        </p>
      ) : (
        <>
          ...
          <p
            style={{ color: "#4a6fa5", fontSize: "13px", margin: "4px 0 0 0" }}
          >
            {role}
          </p>
          <p
...
function StatusBadge({
  ...
  return (
    ...
    >
      ...
      <p style={{ color: c.msgColor, fontSize: "13px", margin: "3px 0 0 0" }}>
        {message}
      </p>
    </div>
  );
